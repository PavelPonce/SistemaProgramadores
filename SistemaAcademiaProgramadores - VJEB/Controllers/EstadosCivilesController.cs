...
namespace SistemaAcademiaProgramadores.Controllers
{
    ...
    public class EstadosCivilesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Estci_Id,Estci_Descripcion,Estci_UsuarioCreacion,Estci_FechaCreacion,Estci_UsuarioModificacion,Estci_FechaModificacion")] tbEstadosCiviles tbEstadosCiviles)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Estci_Id,Estci_Descripcion,Estci_UsuarioCreacion,Estci_FechaCreacion,Estci_UsuarioModificacion,Estci_FechaModificacion")] tbEstadosCiviles tbEstadosCiviles)
        {
            if (ModelState.IsValid)
            {
